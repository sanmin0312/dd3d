...
class FCOS3DInference():
    ...
    def forward_for_single_feature_map(
        ...
        for i in range(N):
            ...
            scores_3d_per_im = torch.sqrt((scores_per_im * box3d_conf_per_im) * torch.sqrt(depth_conf_per_im+EPS) + EPS)
