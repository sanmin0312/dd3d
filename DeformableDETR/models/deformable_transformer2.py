...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, qs, kvs, pos_embeds=None):
        ...
        # encoder
        memory = self.encoder(qs_flatten, kvt1s_flatten, kvt2s_flatten, spatial_shapes, level_start_index, valid_ratios,
...
class DeformableTransformerEncoderLayer(nn.Module):
    ...
    def forward(self, q, kvt1, kvt2, pos, reference_points, spatial_shapes, level_start_index, padding_mask=None):
        ...
        # t-2 cross attention
        src2 = self.t2_cross_attn(q, reference_points, self.with_pos_embed(kvt2, pos), spatial_shapes, level_start_index, padding_mask)
...
class DeformableTransformerEncoder(nn.Module):
    ...
    def forward(self, q, kvt1, kvt2, spatial_shapes, level_start_index, valid_ratios, pos=None, padding_mask=None):
        ...
        for _, layer in enumerate(self.layers):
            output = layer(output, kvt1, kvt2, pos, reference_points, spatial_shapes, level_start_index, padding_mask)
